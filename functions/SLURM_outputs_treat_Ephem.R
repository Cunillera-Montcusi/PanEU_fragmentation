...
png(filename ="Loss_Alph_Bet_Ephem.png",
...
png(filename ="Loss_GammEphem.png",
...
# Plot EU map with coefficients for ephemeral freshwaters ####
plot_amazing <- list()
...
png(filename ="EU_degr_Ephem.png",width =350*7 ,height =800*7 ,units ="px",res = 300)
